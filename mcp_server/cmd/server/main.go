...
DESCRIPTION:
    ...
    This server exposes seven main tools:
    
    Low-level building block tools:
    ...
    - update_building_block: Update Custom Resource instances with new specifications
    - delete_building_block: Delete Custom Resource instances by building block type and name
    
    High-level platform capabilities:
    - list_platform_capabilities: Discover high-level platform capabilities with execution prompts
